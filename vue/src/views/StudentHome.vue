...
const modules = [
  {
    ...
    label: '首页',
    actionText: '浏览课程',
    description: '查看所有可用课程，选择感兴趣的课程开始学习。',
    stats: [
      { label: '我的课程', value: '8' },
      { label: '待学习', value: '3' },
      { label: '已完成', value: '5' }
    ],
    actions: ['查看全部课程', '搜索课程', '加入新课程']
  },
  {
    id: 'resources',
    label: '学习资料',
    actionText: '上传资料',
    description: '浏览和搜索学习资源，上传自己的学习资料与同学分享。',
    stats: [
      { label: '资源总数', value: '1,204' },
      { label: '我的上传', value: '12' },
      { label: '我的收藏', value: '28' }
    ],
    actions: ['浏览资源', '搜索资源', '我的收藏']
  },
  {
    id: 'questions',
    label: '问答广场',
    actionText: '提出问题',
    description: '向教师提问，查看问题回答，参与学习讨论。',
    stats: [
      { label: '我的提问', value: '15' },
      { label: '待回答', value: '3' },
      { label: '已解答', value: '12' }
    ],
    actions: ['查看全部问题', '搜索问题', '我的提问']
  },
  {
    id: 'profile',
    label: '个人中心',
    actionText: '编辑资料',
    description: '管理个人信息、查看学习记录和消息通知。',
    stats: [
      { label: '未读消息', value: '5' },
      { label: '学习时长', value: '120h' },
      { label: '积分', value: '1,250' }
    ],
    actions: ['我的资源', '我的提问', '消息中心']
  }
]
...
if (userInfo) {
  try {
    ...
    currentUser.name = user.realName || user.username || '学生'
